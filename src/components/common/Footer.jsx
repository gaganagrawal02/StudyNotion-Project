        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="gagan02agrawal@gmail.com?body=fell free to type">
                    Gmail
                  </a>
                </li>
                <li>
            ...
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/gaganagrawal02/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://github.com/gaganagrawal02" target="blank">
